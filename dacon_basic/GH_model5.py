...
class GH(nn.Module):
    def __init__(self):
        ...
        self.l11 = nn.Conv2d(512, 1024, 3, padding=1)

        self.l12 = nn.Conv2d(1024, 1024, 3, padding=1)
        self.l13 = nn.Conv2d(1024, 1024, 3, padding=1)

        self.ll1 = nn.Linear(4096, 1024)
        self.ll2 = nn.Linear(1024, 256)
        self.ll3 = nn.Linear(256, 10)
    ...
    def forward(self, x):       #(n,3,32,32)
        ...
        # (n,512,4,4)
        x, residual = self.GH_Resnet(x, residual, 1, self.l12, self.l13)
        # (n,1024,2,2)
